...
<CardGroup cols={2}>
  ...
  <Card title="Custom developer integration" icon="code" href="/tutorials/api-integration">
    No plugin for your stack? Embed the Element yourself, or go fully [headless](/integrations/headless) with the REST API.
  </Card>
  <Card title="Supported file types" icon="file" href="/specifications/file-types">
    See which formats Filecheck can accept, check, fix, and convert.
  </Card>
  <Card title="Supported languages" icon="language" href="/specifications/languages">
    75 display languages for the customer-facing upload experience.
  </Card>
</CardGroup>
