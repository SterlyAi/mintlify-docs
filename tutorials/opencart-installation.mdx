...
<Frame caption="From install to downloading processed files, in five stages">
  <iframe src="https://cdn.filecheck.io/videos/welcome-oc.html" title="Getting started with Filecheck" loading="lazy" style={{ width: "100%", aspectRatio: "16 / 9", border: "0", borderRadius: "12px" }} />
</Frame>
