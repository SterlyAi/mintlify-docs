...
<Frame caption="A workflow runs in two phases: intake while the customer waits, then processing after a trigger">
  <iframe src="https://cdn.filecheck.io/videos/workflow.html" title="How a workflow works" loading="lazy" style={{ width: "100%", aspectRatio: "16 / 9", border: "0", borderRadius: "12px" }} />
</Frame>
