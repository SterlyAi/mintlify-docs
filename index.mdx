...
<Frame caption="Filecheck in 30 seconds">
  <iframe src="https://cdn.filecheck.io/videos/intro.html" title="Filecheck in 30 seconds" loading="lazy" style={{ width: "100%", aspectRatio: "16 / 9", border: "0", borderRadius: "12px" }} />
</Frame>
...
<CardGroup cols={2}>
  ...
  <Card title="Install Filecheck" icon="plug" href="/tutorials/wordpress-installation">
